...
class ModifiedMethodsHelper {
    ...
    private List<String> runDiffJ(File ancestorFile, File targetFile) {
        Process diffJ = ProcessRunner.runProcess(System.getProperty('dependencies.path'), 'java', '-jar', this.diffJOption, "--brief", ancestorFile.getAbsolutePath(), targetFile.getAbsolutePath())
